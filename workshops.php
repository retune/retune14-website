	    	...
	    	<div class="row" id="interfaces">
				<div class="workshop_info col-md-6 col-xs-12">
					<div class="description col-sm-8 col-sm-offset-2 col-xs-12 col-xs-offset-0" style="padding-bottom:100px;">
						...
						<h3>Let’s get physical with vvvv & draw with your body</h3>
						<h4>by Jochen Leinberger and Mark Lukas<br/>1 day | 26.09.2014, 10:00 – 16:00<br/>30€ (student: 24€) – <a href="http://retune.de/2014/tickets#tito-register-form">SIGN UP</a></h4>
	    	...
	    	<div class="row" id="3d">
				<div class="workshop_info col-md-6 col-xs-12">
					<div class="description col-sm-8 col-sm-offset-2 col-xs-12 col-xs-offset-0" style="padding-bottom:100px;">
						...
						<h4>by Bram de Vries<br/>1 day | 26.09.2014, 10:00 - 16:00<br/>30€ (student: 24€) – <a href="http://retune.de/2014/tickets#tito-register-form">SIGN UP</a></h4>
	    	...
	    	<div class="row" id="superobjects">
				<div class="workshop_info col-md-6 col-xs-12">
					<div class="description col-sm-8 col-sm-offset-2 col-xs-12 col-xs-offset-0" style="padding-bottom:100px;">
						...
						<h3>Rebooting Programming as a Creative Practice</h3>
	    	...
	    	<div class="row" id="vj">
				<div class="workshop_info col-md-6 col-xs-12">
					<div class="description col-sm-8 col-sm-offset-2 col-xs-12 col-xs-offset-0" style="padding-bottom:100px;">
						...
						<h4>by Lucas Gutierrez and Klaas von Karlos<br/>2 days | 24. & 25.09.2014, 18:00 – 22:00<br/>presentation: 26.09.2014 at retune.<br/>100€ (members of Berliner Pool and FabLab Berlin: 60€)<br/>– <a href="http://form.jotformpro.com/form/42296842650964?">REGULAR SIGNUP</a> / <a href="http://form.jotformpro.com/form/42302847979971?" target="_blank">MEMBER SIGNUP</a></h4>
	    	...
	    	<div class="row" id="ccl">
				<div class="workshop_info col-md-6 col-xs-12">
					<div class="description col-sm-8 col-sm-offset-2 col-xs-12 col-xs-offset-0" style="padding-bottom:100px;">
						...
						<h4>5 days | 22. – 26.09.2014<br/>application required</h4>
