<?php require_once('head.php'); ?> 
    	...
    	<div id="speakers" class="container full-width-container">
			...
			<div class="row" id="aparede">
				...
				<div id="aparede_image" class="speaker_images col-md-6 hidden-sm hidden-xs">			
			...
			<div class="row" id="uva"> 
				<div id="uva_image" class="speaker_images col-md-6 hidden-sm hidden-xs">			
					<nav class="nav_images left">
			...
			<div class="row" id="visnjic"> 
				...
				<div id="visnjic_image" class="speaker_images col-md-6 hidden-sm hidden-xs">			
					<nav class="nav_images">
			...
			<div class="row" id="wang"> 
				<div id="wang_image" class="speaker_images col-md-6 hidden-sm hidden-xs">			
					<nav class="nav_images left">
			...
			<div class="row" id="wellmer"> 
				...
				<div id="wellmer_image" class="speaker_images col-md-6 hidden-sm hidden-xs">			
					<nav class="nav_images">
