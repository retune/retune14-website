    	...
    	<div class="container full-width-container">				
	    	<div class="row" id="start">
				...
				<div class="col-md-12 col-lg-10">
					<div class="sr-only">
						<h1>retune 2014 - creative technology conference</h1>
						<h2>inside the mirror</h2>
						<strong>26. - 28.09.2014, Arena Glashaus Berlin</strong>
					</div>
				</div>
			...
			<div class="row" id="supporter">
				<div class="col-sm-6 text-center">
					<h1>sponsors</h1>
					<a href="http://mailchimp.com" target="_blank"><img src="img/mailchimp.png" alt="mailchimp"/></a><br/>
